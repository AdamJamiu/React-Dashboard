...
// import greenChart from '../../../../images/svg/decorative/green-chart.svg'


const tableHeaders = ["Name", "Price", "24H Change", "24H Volume", "Chart", "Trade"];
        ...
        <TableBody >
          {bodyData.map((row, idx) => (
            ...
            >
              ...
              <TableCell align="right"><img src={row.chart} /> </TableCell>
